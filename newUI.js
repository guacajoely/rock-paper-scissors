    ...
    buttons.forEach(id => id.addEventListener("click",  function(e){
        ...
        compText.innerHTML = 'The computer selected: ' + computerSelection + "</br>";
            ...
            if(playerSelection === computerSelection){
                console.log('TIE')
                result.innerHTML = `TIE! You and the computer both chose <strong>${computerSelection}</strong>. </br> Please try again.`
                return
            }
...
score.innerHTML = 'The current score is </br> <strong>You:' + wins + ' </br> Computer:' + losses + '</strong>'
